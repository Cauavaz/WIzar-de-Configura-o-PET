...
function mostrarResumo() {
    ...
    const todosPassosCompletos = validarTodosPassos();
    
    if (!todosPassosCompletos) {
        Swal.fire({
            title: 'Passos Incompletos',
            html: '<p class="text-lg">Você precisa completar todos os passos obrigatórios antes de publicar o site.</p><p class="text-sm text-gray-600 mt-2">Clique no widget "Progresso Geral" para ver o que está faltando.</p>',
            icon: 'warning',
